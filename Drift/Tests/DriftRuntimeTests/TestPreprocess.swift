...
class TestPreprocess: XCTestCase {
    ...
    func testEmptyFile() {
        let file = """
        """
        let actual = Preprocess.convertComment(in: file)
        let expected = """
        """
        XCTAssertEqual(expected, actual)
    }
    
    func testContainsOnlyComment() {
        let file = """
        /// comment
        """
        let actual = Preprocess.convertComment(in: file)
    ...
    func testNotStartWithTripleSlashes() {
        let file = """
        if true {/// comment
        }
        """
    ...
    func testConvertBigFile() {
        let file = Resources.sample4
        let actual = Preprocess.convertComment(in: file)
        let expected =
"""
/**
